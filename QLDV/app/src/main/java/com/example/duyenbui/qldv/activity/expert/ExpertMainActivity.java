package com.example.duyenbui.qldv.activity.expert;
...
public class ExpertMainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.expert_toolbar);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.expert_nav_view);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.expert_action_search) {
            return true;
        }
